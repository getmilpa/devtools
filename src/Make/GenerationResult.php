...
final class GenerationResult
{
     ...
     * @param Flavor|null                $flavor     the {@see Flavor} this generation targeted (`ControllerGenerator`
     *                                               only — `null` for entities, which have no flavor); pass it
     *                                               straight through to {@see VerifyRunner::run()}
